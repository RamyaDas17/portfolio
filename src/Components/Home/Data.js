...
function Data() {
  return (
    <div className='home_data'>
        <h1 className='home_title'>Ramya K
             <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home_description'>I'm a passionate web developer. As a recent graduate,
                                        I bring fresh perspectives and a hunger for learning to every project I undertake.</p>
